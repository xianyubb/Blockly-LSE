...
const Player_setFire = {
    "type": "Player_setFire",
    "message0": "setFire for %1 seconds with effect %2",
    "args0": [
        {
            "type": "input_value",
            "name": "time",
...
const Player_clearItem = {
    ...
    "message0": "clearItem type %1 amount %2",
    "args0": [
        {
            "type": "input_value",
            "name": "type",
...
const Player_setSidebar = {
    ...
    "message0": "setSidebar title %1 data %2 sort %3",
    "args0": [
        {
            "type": "input_value",
            "name": "title",
...
const Player_setCurrentExperience = {
    ...
    "message0": "setCurrentExperience %1",
    "args0": [
        {
            "type": "input_value",
            "name": "count",
...
const Player_getXpNeededForNextLevel = {
    ...
    "message0": "getXpNeededForNextLevel",
    "args0": [],
    "output": "Number",
    "colour": 285,
...
const Player_removeSidebar = {
    ...
    "message0": "removeSidebar",
    "args0": [],
    "output": "Boolean",
    "colour": 285,
    "tooltip": "移除玩家自定义侧边栏",
    "helpUrl": "", "previousStatement": null,
    "nextStatement": null
...
const Player_setBossBar = {
    ...
    "message0": "setBossBar uid %1 title %2 percent %3 color %4",
    "args0": [
        {
            "type": "input_value",
            "name": "uid",
...
const Player_getEntityFromViewVector = {
    ...
    "message0": "getEntityFromViewVector maxDistance %1",
    "args0": [
        {
            "type": "input_value",
            "name": "maxDistance",
...
const Player_getBlockFromViewVector = {
    ...
    "message0": "getBlockFromViewVector includeLiquid %1 solidOnly %2 maxDistance %3 fullOnly %4",
    "args0": [
        {
            "type": "input_value",
            "name": "includeLiquid",
...
const Player_setAbility = {
    ...
    "message0": "setAbility AbilityID %1 value %2",
    "args0": [
        {
            "type": "input_value",
            "name": "AbilityID",
...
const Player_setExtraData = {
    ...
    "message0": "setExtraData name %1 data %2",
    "args0": [
        {
            "type": "input_value",
            "name": "name",
...
const Player_setScore = {
    ...
    "message0": "setScore name %1 value %2",
    "args0": [
        {
            "type": "input_value",
            "name": "name",
...
const Player_addScore = {
    ...
    "message0": "addScore name %1 amount %2",
    "args0": [
        {
            "type": "input_value",
            "name": "name",
...
const Player_reduceScore = {
    ...
    "message0": "reduceScore name %1 amount %2",
    "args0": [
        {
            "type": "input_value",
            "name": "name",
...
const Player_sendModalForm = {
    ...
    "message0": "sendModalForm title %1 content %2 confirmButton %3 cancelButton %4",
    "args0": [
        {
            "type": "input_value",
            "name": "title",
...
const Player_sendSimpleForm = {
    ...
    "message0": "sendSimpleForm title %1 content %2",
    "args0": [
        {
            "type": "input_value",
            "name": "title",
...
const Player_sendCustomForm = {
    ...
    "message0": "sendCustomForm json %1",
    "args0": [
        {
            "type": "input_value",
            "name": "json",
...
const Player_setTitle = {
    ...
    "message0": "setTitle content %1 type %2 fadeInTime %3 stayTime %4 fadeOutTime %5",
    "args0": [
        {
            "type": "input_value",
            "name": "content",
...
const Player_addEffect = {
    ...
    "message0": "addEffect id %1 tick %2 level %3 showParticles %4",
    "args0": [
        {
            "type": "input_value",
            "name": "id",
...
const Player_setFollowRange = {
    ...
    "message0": "%1 set follow range to %2",
    "args0": [
        {
            "type": "field_variable",
            "name": "VAR",
...
const Player_setKnockbackResistance = {
    ...
    "message0": "%1 set knockback resistance to %2",
    "args0": [
        {
            "type": "field_variable",
            "name": "VAR",
...
const Player_setUnderwaterMovementSpeed = {
    ...
    "message0": "%1 set underwater movement speed to %2",
    "args0": [
        {
            "type": "field_variable",
            "name": "VAR",
...
const Player_setLavaMovementSpeed = {
    ...
    "message0": "%1 set lava movement speed to %2",
    "args0": [
        {
            "type": "field_variable",
            "name": "VAR",
...
export const PlayerAPI_blocks = Blockly.common.createBlockDefinitionsFromJsonArray([
    ...
    Player_InWall, Player_InSnow, Player_isOP, Player_Kick, Player_Tell, Player_sendText, Player_sendToast, Player_runcmd, Player_talkAs, Player_talkAsTo, Player_disconnect,
    Player_distanceTo, Player_distanceToSqr, Player_teleport, Player_teleportTo, Player_kill, Player_hurt, Player_heal, Player_setMaxHealth, Player_setHealth, Player_setHungry,
    Player_setFire, Player_stopFire, Player_rename, Player_getBlockStandingOn, Player_getDevice, Player_getHand, Player_getOffHand, Player_getInventory, Player_getArmor, Player_getEnderChest, Player_getRespawnPosition,
    Player_giveItem, Player_clearItem, Player_refreshItems, Player_refreshChunks, Player_setPermLevel, Player_setGameMode, Player_addLevel, Player_reduceLevel, Player_getLevel, Player_setLevel, Player_resetLevel,
    Player_setSidebar, Player_getCurrentExperience, Player_setCurrentExperience, Player_getTotalExperience, Player_setTotalExperience, Player_addExperience, Player_reduceExperience, Player_getXpNeededForNextLevel,
    Player_transfer, Player_crash, Player_setSidebar, Player_setBossBar, Player_removeBossBar, Player_getNbt, Player_setNbt, Player_addTag, Player_removeTag, Player_hasTag, Player_getAllTags, Player_getAbilities,
    Player_getAttributes, Player_setAbsorption, Player_setAttackDamage, Player_setMaxAttackDamage, Player_IsSpectator, Player_setSprinting, Player_getEntityFromViewVector, Player_getBlockFromViewVector, Player_sendPacket, Player_getBiomeId,
    Player_getBiomeName, Player_isSprinting, Player_removeSidebar, Player_setAbility, Player_isSimulatedPlayer, Player_setExtraData, Player_getExtraData, Player_getScore, Player_setScore,
    Player_delExtraData, Player_addScore, Player_reduceScore, Player_deleteScore, Player_sendModalForm, Player_sendSimpleForm, Player_sendCustomForm, Player_sendForm, Player_setScale, Player_setTitle, Player_distanceToPos, Player_addMoney,
    Player_getAllEffects, Player_addEffect, Player_removeEffect, Player_setFollowRange, Player_setKnockbackResistance, Player_setLuck, Player_setMovementSpeed, Player_setLavaMovementSpeed, Player_setUnderwaterMovementSpeed,
]);
